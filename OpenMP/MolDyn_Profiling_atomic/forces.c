 ...
 */
  ...
  #pragma omp parallel for default(none) shared(x,f,npart,sideh,rcoffs,side)\
     private(i,j,xi,yi,zi,fxi,fyi,fzi,xx,yy,zz,rd,rrd,rrd2,rrd3,rrd4,rrd6,rrd7,r148,\
     forcex, forcey, forcez) \
     reduction(-:vir) reduction(+:epot) schedule(static,10)
